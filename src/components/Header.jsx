...
const NavLink = ({ href, children }) => (
  <a
    href={href}
    className="text-medium-gray hover:text-accent transition-colors duration-300 px-3 py-2 text-sm font-medium relative group"
  >
    {children}
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden lg:flex items-center  space-x-5">
            ...
            <div className="flex items-center space-x-4 ml-4">
              ...
              <SocialIconLink href="https://www.linkedin.com/in/chaitanya-yelamasetty">
          ...
          >
            <nav className="flex flex-col text-center">
              ...
              <div className="flex justify-center space-x-6 px-6 py-4 border-t border-primary/50">
                ...
                <SocialIconLink href="https://x.com/Chaitanya154975">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18.901 1.144h3.762L14.417 9.87l7.545 11.002h-6.24L11.564 12.012l-6.31 8.864H1.385l8.037-11.196L1.082 1.144h7.828l4.914 6.789L18.901 1.144zm-1.666 17.502h2.208L7.697 3.529H5.35L17.235 18.646z" /></svg>
                </SocialIconLink>
              </div>
            </nav>
